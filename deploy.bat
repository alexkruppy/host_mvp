...
echo   ssh root@192.168.1.69 "git clone https://github.com/alexkruppy/resttest.git /tmp/resttest && cd /tmp/resttest && docker build -t rest-app . && docker run -d --name rest-app --restart unless-stopped -p 8080:8080 rest-app"
